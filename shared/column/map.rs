// Shared map column logic. Provided in scope by the including
// module: std::collections::HashMap, std::hash::Hash, super::super::error::Result, super::super::protocol::block::ReadColumnContext, super::{ClickHouseColumn, ClickHouseColumnData, ClickHouseValue}.
    ...
    fn element_range(&self, index: usize) -> Result<(usize, usize)> {
        let start = if index == 0 {
            ...
            self.offsets.get(index - 1).copied().ok_or_else(|| {
                super::super::error::Error::Protocol("MapColumnData: index out of bounds".into())
            })? as usize
        };
