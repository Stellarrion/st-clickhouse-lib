// Shared Nullable(T) column logic. Expects in scope (provided by the
// including module): Result, ReadColumnContext, ClickHouseColumn,
// ClickHouseColumnData, ClickHouseValue.
