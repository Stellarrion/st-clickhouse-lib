// Shared geo column logic. Provided in scope by the including
...
pub struct PointColumnData<'a> {
    data: super::super::column::plain::PlainColumnData<'a, f64>,
    count: usize,
}
        ...
        if rows == 0 {
            return Ok(RingColumnData {
                ...
                points: PointColumnData {
                    data: super::super::column::plain::PlainColumnData::empty(),
                    count: 0,
                },
            });
        }
